...
def SetMeanValue(cam_info: 'CameraInfo', val1: 'float', val2: 'float', val3: 'float') -> "void":
    return _openncc.SetMeanValue(cam_info, val1, val2, val3)
SetMeanValue = _openncc.SetMeanValue
