...
#include <ncc_sdk/win/semaphore.h>
#include <time.h>
#include <stdint.h>
#include <fstream>
#include<sys/types.h>
...
void  cls_show_img_func(void *data, int w, int h, float scale, char *name, int nn_fov_show, CameraInfo *nnparm, char *nnret,float min_score)
{
	cv::Mat yuvImg;
